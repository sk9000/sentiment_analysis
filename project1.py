...
def hinge_loss_single(feature_vector, label, theta, theta_0):
    ...
    """
    # Your code here
    y = np.matmul(theta, feature_vector)+theta_0
    hingeloss = np.max([0, (1 - label * y)])
    return hingeloss
...
def pegasos_single_step_update(
    ...
    """
    # Your code here
    if np.dot(feature_vector, current_theta)*label + current_theta_0 <= 1:
